...
-export(['enum_symbol_by_value_Router.router_service'/1, 'enum_value_by_symbol_Router.router_service'/1]).
...
%% enumerated types
-type 'Router.router_service'() :: 'User'.
-export_type(['Router.router_service'/0]).
...
get_msg_defs() ->
    [{{enum, 'Router.router_service'}, [{'User', 1}]}].
...
get_enum_names() -> ['Router.router_service'].
...
find_enum_def('Router.router_service') -> [{'User', 1}];
find_enum_def(_) -> error.


enum_symbol_by_value('Router.router_service', Value) ->
    'enum_symbol_by_value_Router.router_service'(Value).


enum_value_by_symbol('Router.router_service', Sym) ->
    'enum_value_by_symbol_Router.router_service'(Sym).


'enum_symbol_by_value_Router.router_service'(1) ->
    'User'.


'enum_value_by_symbol_Router.router_service'('User') ->
    1.
